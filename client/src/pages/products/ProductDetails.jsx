      ...
      <div className="h-screen w-screen bg-white flex flex-col">
        ...
        <div className="flex flex-1 p-6 gap-6 overflow-hidden">
          ...
          <div className="flex-[1] flex flex-col rounded shadow-sm p-4">
            ...
            <div className="h-[400px] w-full flex justify-center items-center mb-4 bg-white border border-gray-200 rounded overflow-hidden">
              {selectedImage ? (
                <img
                  src={selectedImage}
                  alt="Selected"
            ...
            {/* Thumbnails */}
            <div className="flex gap-3 justify-center pt-2 border-t border-gray-300 overflow-x-auto">
