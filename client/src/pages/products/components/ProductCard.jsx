...
export const ProductCard = ({ product }) => {
  ...
  const handleAddToCart = async () => {
    try {
      const userId = "64cxxxxxxxxxx"; // replace with actual logged-in user ID
      await addToCart({
        userId,
      ...
      <div className="flex flex-col p-4 flex-1">
        <div className="flex justify-between items-center">
          ...
          <div
            ...
            className={`cursor-pointer transition-colors duration-200 ${liked ? 'text-red-500' : 'text-[#6F9674]'
              }`}
          >
            <svg
              width="24"
