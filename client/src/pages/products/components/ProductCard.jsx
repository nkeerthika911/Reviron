...
export const ProductCard = ({ product }) => {
  ...
  const handleAddToCart = async () => {
    try {
      const res = await axios.post(`${import.meta.env.VITE_BASE_URL}/api/cart/add`, {
  ...
  const handleToggleFavorite = async (e) => {
    ...
    try {
      const res = await axios.patch(`${import.meta.env.VITE_BASE_URL}/api/products/favourite/${product._id}`);
