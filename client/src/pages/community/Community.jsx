...
export const Community = () => {
  return (
    <>
      <Navbar />
      <div className="flex justify-center pt-8 bg-gray-100">
        <div className="flex flex-col p-4 shadow rounded-lg w-full max-w-md bg-white">
          <div className="flex-1 flex flex-row items-center mb-4">
          ...
          <div className="flex-1 flex flex-row justify-around">
            <div className="flex-2 flex justify-center text-green-600 cursor-pointer">
              <svg
            ...
            <div className="flex-2 flex justify-center text-blue-600 cursor-pointer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5 mr-1"
                fill="currentColor"
